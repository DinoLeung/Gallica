...
public class YoutubeListActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String topicId = intent.getStringExtra("link");
...
public class DownloadDialog extends AsyncTask<String, Void , String>{
	...
	protected void onPostExecute(String result) {
		...
		try {
			...
			TextView tvTitleTextView  = (TextView) YoutubeListActivity.this.findViewById(R.id.tvTite);			
			tvTitleTextView.setText(jsonData2.getString("$t").toString());
			
			TextView tvAuthTextView  = (TextView) YoutubeListActivity.this.findViewById(R.id.tvAuthr);
			...
			Button btn = (Button)YoutubeListActivity.this.findViewById(R.id.button1);
			...
			btn.setOnClickListener(new OnClickListener(){
				...
				public void onClick(View v) {
					...
					AlertDialog dlg = new AlertDialog.Builder(YoutubeListActivity.this)
			...
			//	tvDespextView.setText(jsDesp);
			ImageView imgYou  = (ImageView) YoutubeListActivity.this.findViewById(R.id.imageViewS);
			
			Picasso.with(YoutubeListActivity.this).load(firstThumeString).resize(320, 160).centerCrop().noFade().into(imgYou);		
			
			JSONArray jsonArray = jsonData.getJSONArray("entry");			
	
			final ListView listView = (ListView) YoutubeListActivity.this.findViewById(R.id.list);
			...
			YoutubePlayAdapter itemAdapter = new YoutubePlayAdapter(YoutubeListActivity.this, R.layout.y_row, ct);
