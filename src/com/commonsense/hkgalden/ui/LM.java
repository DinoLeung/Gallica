...
public class LM extends Activity {
	...
	private List<com.commonsense.hkgalden.model.Lm> lm = new ArrayList<com.commonsense.hkgalden.model.Lm>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(LM.this);
		boolean dark  =  preferences.getBoolean("dark", false);
		
		setTitle(getResources().getString(R.string.action_lm));
		...
		lm = DatabaseManager.getInstance().getAllLM();
		
		listItem = new ArrayList<HashMap<String, String>>();
		
		for (int i = 0; i < lm.size(); i++){
			HashMap<String, String> item = new HashMap<String, String>();
			String l = lm.get(i).getId();
			
			history = DatabaseManager.getInstance().getHistory(l);
		...
		//long click item
				list.setOnItemLongClickListener(new OnItemLongClickListener() {
					...
					public boolean onItemLongClick(AdapterView<?> parent, View view,
						...
						DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
						    ...
						    public void onClick(DialogInterface dialog, int which) {
						        ...
						        case DialogInterface.BUTTON_POSITIVE:
						            //Yes button clicked
						        	DatabaseManager.getInstance().delLm(lm.get(position));
						...
						AlertDialog.Builder builder = new AlertDialog.Builder(LM.this);
